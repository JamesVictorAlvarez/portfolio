    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[55rem] bg-gradient-conic from-black-600 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[55rem] bg-gradient-conic from-transparent via-transparent to-black-600 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-black-250 blur-2xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-black-800 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[50rem] -translate-y-[7rem] bg-black-800 "
        ></motion.div>
